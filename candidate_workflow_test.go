...
func TestDarwinCandidateWorkflowUsesTheExactOwnerWorkflowsAndNativeGate(t *testing.T) {
	...
	for _, required := range []string{
		...
		"make -C tests compose-candidate-plan", "system-theme", "system-native-focus", "system-native-cursor", "system-native-keyboard", "system-visibility", "system-performance", "system-commands", "candidate-actions-artifacts.json",
	...
	order := []string{"system-theme", "system-native-focus", "system-native-cursor", "system-native-keyboard", "system-visibility", "system-performance", "system-commands"}
